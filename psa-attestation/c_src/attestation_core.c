...
/*!
 * This is a hack by the Veracruz project. Using `boot_data` involved lots of
 * pain that is unecessary on this platform.
 */
 //static uint8_t fw_hash_static[32];
 //static uint8_t csr_hash_static[32];
/*!
 * \var boot_data
 *
...
//                                         uint8_t  **tlv_ptr)
// {
//     printf("attest_get_tlv_by_module module:%d\n", module);
//     printf("looking at boot_data.data:\n");
//     for (uint32_t i = 0; i < 78; i++) {
//         printf("0x%02x ", boot_data.data[i]);
//     }
//     printf("\n");
...
//     while(tlv_curr < tlv_end) { //for (; (tlv_curr < tlv_end) && (count < 2); tlv_curr += tlv_entry.tlv_len) {
//         printf("attest_get_tlv_by_module iterating with count:%d\n", count);
//         printf("tlv_curr:");
//         for (uint32_t i = 0; i < 16; i++) {
//             printf("0x%02x ", tlv_curr[i]);
//         }
//         printf("\n");
//         /* Create local copy to avoid unaligned access */
//         (void)tfm_memcpy(&tlv_entry, tlv_curr, SHARED_DATA_ENTRY_HEADER_SIZE);
//         printf("attest_get_tlv_by_module checkint tlv_entry.tlv_type:%d\n", GET_IAS_MODULE(tlv_entry.tlv_type));
...
//#if 1 //INDIVIDUAL_SW_COMPONENTS /* DEPRECATED */
/*!
...
// {
//     printf("attest_add_all_sw_components started\n");
//     uint16_t tlv_len;
//     uint8_t *tlv_ptr;
//     uint8_t  tlv_id;
//     int32_t found;
...
//     printf("attest_add_all_sw_components completed successfully\n");
//     return PSA_ATTEST_ERR_SUCCESS;
// }
 ...
 */
// static enum psa_attest_err_t
// attest_add_instance_id_claim(const uint8_t *p_instance_id, size_t instance_id_len, struct attest_token_ctx *token_ctx)
// {
...
//         0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x31,
//     };
//     memcpy(buf, IMPLEMENTATION_ID, sizeof(IMPLEMENTATION_ID));
//     *size = sizeof(IMPLEMENTATION_ID);
//     return TFM_PLAT_ERR_SUCCESS;
// }

// enum tfm_plat_err_t tfm_plat_get_boot_seed(uint32_t size, uint8_t *buf)
// {
//     const uint8_t BOOT_SEED_VALUE[BOOT_SEED_SIZE] = {
//         0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
//         0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
//         0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
//         0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,
//     };
//     memcpy(buf, BOOT_SEED_VALUE, size);
//     return TFM_PLAT_ERR_SUCCESS;
// }
...
// {
//     const int32_t CALLER_ID = 0xdeadbeef;
//     *caller_id = CALLER_ID;
//     return PSA_ATTEST_ERR_SUCCESS;
// }
